...
const WarehouseDashboard = () => {
  ...
  const handleAddProduct = () => {
    setData((prevData) => ({
      ...prevData,
      productStockDetails: [...prevData.productStockDetails, newProduct]
    }));
    setNewProduct({
      product: '',
      reachDate: '',
  ...
  const handleNewProductChange = (event, field) => {
      ...
      <div className="warehouse-content">
        ...
        <Box className="warehouse-dashboard-container">
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Paper className="warehouse-dashboard-card">
                <Typography variant="h6">Add New Product Stock</Typography>
                <Box className="warehouse-add-product-form">
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <TextField
                        label="Reach Date"
                        type="date"
                        value={newProduct.reachDate}
                        onChange={(e) => handleNewProductChange(e, 'reachDate')}
                        InputLabelProps={{ shrink: true }}
                        fullWidth
                      />
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <TextField
                        ...
                        onChange={(e) => handleNewProductChange(e, 'shipmentDate')}
                        InputLabelProps={{ shrink: true }}
                        fullWidth
                      />
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <TextField
                        label="Units In Hand"
                        value={newProduct.unitsInHand}
                        onChange={(e) => handleNewProductChange(e, 'unitsInHand')}
                        fullWidth
                      />
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <TextField
                        ...
                        value={newProduct.unitsOnOrder}
                        onChange={(e) => handleNewProductChange(e, 'unitsOnOrder')}
                        fullWidth
                      />
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <Select
                        ...
                        onChange={(e) => handleNewProductChange(e, 'warehouse')}
                        fullWidth
                      >
                        {data.warehouses.map((wh, i) => (
                          <MenuItem key={i} value={wh.name}>
